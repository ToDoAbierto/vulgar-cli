  ...
  switch (options.type) {
    ...
    case 'ngs':
      ...
      case 'r':
        ...
        // Specify the subgenerator that this component should
        // interface with
        options.subgenerator = 'route';

        // Specify a success function if you need extra logic post generation
        options.functions = {
          success: function(options) {
            routeGenerationSuccess(options);
          }
        }
...
var routeGenerationSuccess = function(options) {

  console.log();
  console.log(chalk.green('  Generation of modular Express route successful!'));
  console.log();
  console.log('  To utilize the ' + options.opts.name + ' route, open \'app\\routes.js\',');
  console.log('  import _' + s(options.opts.name).slugify().value() + '.router.js, and load the API routes:');
  console.log();
  console.log('    // Load our API routes for the new route');
  console.log('    import ' + s(options.opts.name).camelize().value() + 'Routes from \'./routes/_' + s(options.opts.name).slugify().value() + '.router.js\';');
  console.log('');
  console.log('      . . .');
  console.log('');
  console.log('    // #### RESTful API Routes');
  console.log('');
  console.log('      // Pass in our Express app and Router');
  console.log('      ' + s(options.opts.name).camelize().value() + 'Routes(app, router);');
  console.log('');
}
