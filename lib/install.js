...
// Import our config object generator and register
// it for use later
var GeneratorConfig = require('./generators/config/index.js');
env.registerStub(GeneratorConfig, 'vulgar:config');
...
function cloneVulgar(options, done) {
  ...
  var name = options.name,
    source = (options.git
               ? 'github.com:datatypevoid/vulgar.git'
               : 'https://github.com/datatypevoid/vulgar.git');
